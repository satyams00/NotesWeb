...
const About = () => {
  return (
    <div className="about-div">
      <h1>Welcome to NotesWeb - Your Ultimate Study Companion!</h1>
      <p>
        At <span>NotesWeb</span>, we are passionate about empowering college
      ...
      <hr />
      <p>
        At <span>NotesWeb</span>, we are committed to ensuring that you have
        ...
        potential. <br />
        Join us at NotesWeb, where learning is simplified and success becomes
        ...
        Happy learning,
        <br />
        <span id="last">The NotesWeb Team.</span>
      </p>
    </div>
  );
};
